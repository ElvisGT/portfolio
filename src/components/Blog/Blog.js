...
const Blog = () => {
    ...
    const API = "https://newsdata.io/api/1/news?apikey=pub_6547d847408d34ede1e81dcb8d10856ec8b9&country=es,us,ca,cn&category=technology,entertainment,science&language=es"; 
        ...
        <div className="blog" id="blog">
                ...
                {news.length === 0 
                    ...
                    :
                        ...
                        item.image_url !== null  ? url_img = item.image_url : url_img = "https://i.ibb.co/QXBX6Nw/pexels-vie-studio-4439425-1.jpg", //si la imgen de la api es null le seteo la url mia
